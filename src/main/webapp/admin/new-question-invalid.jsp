...
<body>
	<p><fmt:message key="test.question.invalidMessage" bundle="${lang}"/></p>
	<form method="post"
		...
		<table style="margin-left: auto; margin-right: auto">
			<tr>
				...
				<td><input type="text" name="question" size=100 value="${param.question}"></td>
			</tr>
			<tr>
				<td style="text-align: right"><label for="answer1"><fmt:message key="test.answer" bundle="${lang}"/> 1</label></td>
				<td><input type="text" name="answer1" size=100 value="${param.answer1}"></td>
			...
			<tr>
				...
				<td><input type="text" name="answer2" size=100 value="${param.answer2}"></td>
			...
			<tr>
				...
				<td><input type="text" name="answer3" size=100 value="${param.answer3}"></td>
			...
			<tr>
				...
				<td><input type="text" name="answer4" size=100 value="${param.answer4}"></td>
