...
<body>
	...
	<p>The test name is already taken.</p>
	<form method="post"	action="${pageContext.request.contextPath}/serv/create-test">
		<table style="margin-left: auto; margin-right: auto">
			...
			<tr>
				...
				<td><input type="text" name="description" size=100 value="${sessionScope.description}"></td>
			</tr>
			<tr>
				<td style="text-align: right"><label for="time">Duration</label></td>
				<td><input type="number" id="time" name="time" min="30" max="180" value="${sessionScope.time}"></td>
			</tr>
			<tr>
